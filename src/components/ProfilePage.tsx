...
import { ArrowLeft, User, Mail, Calendar, Trophy, Edit3, Save, X, Star, Settings, Camera, Shield, Target, Eye, EyeOff, FileText, Code, CheckCircle, Clock, Zap, BookOpen, Lock, Users, Copy, Gift, Share2 } from 'lucide-react';
  ...
  const achievements = [
    ...
    { 
      ...
      unlocked: userData?.createdAt ? 
        (Date.now() - new Date(userData.createdAt).getTime()) >= (7 * 24 * 60 * 60 * 1000) : false,
      rarity: 'rare',
      points: 300,
      category: 'Special'
    },
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <button
                  onClick={onBack}
                  className="p-3 hover:bg-slate-800/50 rounded-xl transition-all duration-300 border border-slate-700/30 backdrop-blur-sm"
                >
                  <ArrowLeft className="w-5 h-5 text-amber-400" />
                </button>
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    <div className="w-12 h-12 bg-gradient-to-br from-amber-500/20 via-amber-400/10 to-amber-600/20 backdrop-blur-md border border-amber-400/30 rounded-2xl flex items-center justify-center shadow-lg shadow-amber-500/20">
                      <User className="w-6 h-6 text-amber-400 drop-shadow-lg" />
                    </div>
                    <div className="absolute -top-1 -right-1 w-4 h-4 bg-amber-400 rounded-full animate-pulse shadow-lg shadow-amber-400/50"></div>
                  </div>
                  <div>
                    <h1 className="text-2xl font-bold bg-gradient-to-r from-amber-400 to-amber-300 bg-clip-text text-transparent drop-shadow-sm">
                      Detective Profile
                    </h1>
                    <p className="text-sm text-slate-300 font-mono uppercase tracking-wider">Command Center</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                <button
                  ...
                  className="p-3 bg-slate-800/50 hover:bg-slate-700/50 text-amber-400 rounded-xl transition-all duration-300 border border-slate-700/30 backdrop-blur-sm shadow-lg hover:shadow-amber-400/10"
            ...
            <div className="flex space-x-2 mt-6 bg-slate-800/30 backdrop-blur-md rounded-2xl p-2 border border-slate-700/30">
              {[
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/30 p-8 shadow-2xl shadow-slate-950/50">
                <div className="text-center mb-6">
                  <div className="w-28 h-28 bg-gradient-to-br from-amber-500/20 via-amber-400/10 to-amber-600/20 backdrop-blur-md border border-amber-400/30 rounded-full flex items-center justify-center mx-auto mb-6 relative shadow-2xl shadow-amber-500/20">
                    <span className="text-4xl font-bold text-amber-200 drop-shadow-lg">
                      {(userData?.displayName || currentUser?.displayName || 'U').charAt(0).toUpperCase()}
                    </span>
                    <button
                      onClick={() => setShowProfilePictureModal(true)}
                      className="absolute -bottom-2 -right-2 w-10 h-10 bg-slate-800/80 hover:bg-slate-700/80 backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 border border-amber-400/30 shadow-lg hover:shadow-amber-400/20"
                    >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3 text-slate-300">
                    ...
                    <span className="text-sm">Rank: {getCurrentRank().name}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/30 p-6 shadow-xl shadow-slate-950/50 hover:shadow-blue-500/10 transition-all duration-300">
                  <div className="flex items-center space-x-3 mb-3">
                    <div className="w-12 h-12 bg-blue-500/20 backdrop-blur-sm rounded-xl flex items-center justify-center border border-blue-400/20">
                      <span className="text-blue-400 text-lg font-bold">🕵️</span>
                    </div>
                    <h3 className="text-lg font-semibold text-slate-100">Cases Solved</h3>
                  </div>
                  <p className="text-4xl font-bold text-blue-400 mb-2">{userData?.completedCases?.length || 0}</p>
                  <p className="text-sm text-slate-400">Detective missions completed</p>
                </div>

                <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/30 p-6 shadow-xl shadow-slate-950/50 hover:shadow-amber-500/10 transition-all duration-300">
                  <div className="flex items-center space-x-3 mb-3">
                    <div className="w-12 h-12 bg-amber-500/20 backdrop-blur-sm rounded-xl flex items-center justify-center border border-amber-400/20">
                      <span className="text-amber-400 text-lg font-bold">💡</span>
                    </div>
                    <h3 className="text-lg font-semibold text-slate-100">Hints Available</h3>
                  </div>
                  <p className="text-4xl font-bold text-amber-400 mb-2">{userData?.hints || 0}</p>
                  <p className="text-sm text-slate-400">Ready for use</p>
                </div>

                <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/30 p-6 shadow-xl shadow-slate-950/50 hover:shadow-green-500/10 transition-all duration-300">
                  <div className="flex items-center space-x-3 mb-3">
                    <div className="w-12 h-12 bg-green-500/20 backdrop-blur-sm rounded-xl flex items-center justify-center border border-green-400/20">
                      <span className="text-green-400 text-lg font-bold">⭐</span>
                    </div>
                    <h3 className="text-lg font-semibold text-slate-100">Total Points</h3>
                  </div>
                  <p className="text-4xl font-bold text-green-400 mb-2">{userData?.totalPoints || 0}</p>
                  <p className="text-sm text-slate-400">Experience earned</p>
                </div>
              </div>

              {/* Quick Actions */}
              <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/30 p-8 shadow-2xl shadow-slate-950/50">
                <h2 className="text-2xl font-bold text-slate-100 mb-6 flex items-center space-x-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    ...
                    className="flex items-center space-x-4 p-6 bg-slate-800/50 hover:bg-slate-700/50 rounded-xl transition-all duration-300 border border-slate-600/30 hover:border-amber-400/30 shadow-lg hover:shadow-amber-400/10 backdrop-blur-sm"
                  >
                    <div className="w-12 h-12 bg-amber-500/20 rounded-xl flex items-center justify-center">
                      <FileText className="w-6 h-6 text-amber-400" />
                    </div>
                    <div className="text-left">
                      <h3 className="font-semibold text-slate-100">View Evidence</h3>
                  ...
                  >
                    ...
                    <div className="text-left">
                      <h3 className="font-semibold text-slate-100">Case Files</h3>
              ...
              <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/30 p-8 shadow-2xl shadow-slate-950/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-4 p-4 bg-gradient-to-r from-orange-500/20 to-red-500/20 hover:from-orange-500/30 hover:to-red-500/30 rounded-xl transition-all duration-300 border border-orange-400/30 hover:border-orange-400/50 shadow-lg hover:shadow-orange-400/10"
                  >
                    <div className="text-2xl">🎯</div>
                    <div className="text-left">
                      <h4 className="font-semibold text-slate-100">Daily Login</h4>
                      <p className="text-sm text-orange-300">{userData?.loginStreak || 0} day streak</p>
                    </div>
                  </button>
                  ...
                  {!userData?.referredBy && (
                    <button
                      ...
                      className="flex items-center space-x-4 p-4 bg-gradient-to-r from-purple-500/20 to-blue-500/20 hover:from-purple-500/30 hover:to-blue-500/30 rounded-xl transition-all duration-300 border border-purple-400/30 hover:border-purple-400/50 shadow-lg hover:shadow-purple-400/10"
                    >
                      <div className="w-8 h-8 bg-purple-500/30 rounded-lg flex items-center justify-center">
                        <Users className="w-4 h-4 text-purple-400" />
                      </div>
                      <div className="text-left">
                        <h4 className="font-semibold text-slate-100">Use Referral Code</h4>
                        <p className="text-sm text-purple-300">Get bonus rewards</p>
                      </div>
                    </button>
                  )}
                  ...
                  <button
                    ...
                    className="flex items-center space-x-4 p-4 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 hover:from-emerald-500/30 hover:to-teal-500/30 rounded-xl transition-all duration-300 border border-emerald-400/30 hover:border-emerald-400/50 shadow-lg hover:shadow-emerald-400/10"
                  >
                    <div className="w-8 h-8 bg-emerald-500/30 rounded-lg flex items-center justify-center">
                      <Share2 className="w-4 h-4 text-emerald-400" />
                    </div>
                    <div className="text-left">
                      <h4 className="font-semibold text-slate-100">Share Your Code</h4>
                      <p className="text-sm text-emerald-300">Invite friends</p>
                    </div>
                  </button>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 p-6">
              ...
              <div className="flex items-center space-x-6">
                <div className={`w-20 h-20 ${getCurrentRank().bgColor} rounded-full flex items-center justify-center`}>
        ...
        {selectedTab === 'referrals' && (
          <div className="space-y-8">
            ...
            <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/30 p-8 shadow-2xl shadow-slate-950/50">
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/30 p-6 mb-6">
                <div className="flex items-center justify-center space-x-4">
                  <div className="text-center">
                    <p className="text-sm text-slate-400 mb-2">Your Referral Code</p>
                    <div className="text-4xl font-bold text-amber-400 font-mono tracking-wider bg-slate-700/50 rounded-lg px-6 py-3 border border-amber-400/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  onClick={copyReferralCode}
                  className="flex items-center justify-center space-x-3 bg-amber-500/20 hover:bg-amber-500/30 border border-amber-400/30 rounded-xl px-6 py-4 transition-all duration-300 backdrop-blur-sm hover:shadow-lg hover:shadow-amber-400/20"
                >
                  <Copy className="w-5 h-5 text-amber-400" />
                  <span className="font-medium text-slate-100">Copy Referral Link</span>
                </button>
                <button
                  onClick={shareReferralCode}
                  className="flex items-center justify-center space-x-3 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-400/30 rounded-xl px-6 py-4 transition-all duration-300 backdrop-blur-sm hover:shadow-lg hover:shadow-blue-400/20"
                >
                  <Share2 className="w-5 h-5 text-blue-400" />
                  <span className="font-medium text-slate-100">Share with Friends</span>
                </button>
              </div>
            </div>
