...
import { ArrowLeft, Star, Search, Monitor, Phone, Book, Folder, ChevronRight, Badge, Trophy } from 'lucide-react';
...
.hidden-plan {
      ...
      <div className="flex-1 p-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            >
              <div className="text-center">
                <Monitor className="w-12 h-12 mx-auto mb-4 text-amber-400" />
            ...
            >
              <div className="text-center">
                <Book className="w-12 h-12 mx-auto mb-4 text-amber-400" />
            ...
            >
              <div className="text-center">
                <Folder className="w-12 h-12 mx-auto mb-4 text-amber-400" />
  ...
  const renderConfrontation = () => (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8">
      <div className="max-w-4xl w-full">
        <div className="bg-slate-800/90 backdrop-blur-xl rounded-2xl border border-amber-500/30 p-8 shadow-2xl">
          <h2 className="text-3xl font-bold text-amber-400 mb-6 text-center">Case Solved!</h2>
          ...
          <div className="flex items-center gap-6 mb-6">
            <img 
              ...
              className="w-24 h-24 rounded-full border-4 border-amber-500/50 object-cover"
            />
            <div className="flex-1 bg-slate-700/50 rounded-lg p-6">
              <p className="text-slate-200 text-lg leading-relaxed">
                "We caught him livestreaming his 'grand comeback' at a café nearby. Here's his confession note - he admits to faking it all to defame Sherpa companies for fame."
              </p>
            </div>
          </div>

          <div className="bg-red-500/20 border border-red-500/50 rounded-lg p-6 mb-6">
            <h3 className="text-xl font-bold text-red-400 mb-3">Confession Note</h3>
            <p className="text-slate-200 text-lg italic">
              "I faked my disappearance to defame Sherpa companies for fame. I wanted to become famous by exposing them, even if it meant lying. I'm sorry for wasting everyone's time."
            </p>
            <p className="text-slate-400 text-sm mt-3">- Rishi Nair</p>
          </div>

          <div className="bg-amber-500/20 border border-amber-500/50 rounded-lg p-6 mb-6">
            <h3 className="text-xl font-bold text-amber-400 mb-3">Case Conclusion</h3>
            <ul className="text-slate-200 space-y-2">
              <li>• Rishi's fake disappearance exposed through digital forensics</li>
              <li>• Sherpa company files defamation charges</li>
              <li>• Real-world consequences of online deception revealed</li>
              <li>• Evidence collected: {solvedPuzzles}/{totalPuzzles} pieces</li>
            </ul>
          </div>
          ...
          <div className="flex items-center justify-center">
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white rounded-lg font-semibold transition-all duration-200 shadow-lg"
            >
              Complete Case
            </button>
          </div>
  ...
  return (
    <div className="relative">
      ...
      {/* Detective-Themed Completion Screen */}
      {showCompletion && (
            ...
            <div className="max-w-2xl w-full">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-slate-300 leading-relaxed">
                  🎉 Outstanding detective work! You've successfully completed your first real visual investigation case.
                </p>
              </div>
              ...
              <div className="bg-slate-800/60 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-8 mb-8 shadow-2xl">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-amber-400">Investigation Report</h2>
                  <div className="flex items-center gap-2 px-4 py-2 bg-green-500/20 text-green-400 rounded-full border border-green-500/30">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs opacity-80">{calculateFinalScore()} points</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-slate-300">Evidence collected: {solvedPuzzles}/{totalPuzzles}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                      <span className="text-slate-300">Investigation type: Visual Investigation</span>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                      <span className="text-slate-300">Case status: ✅ SOLVED</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 bg-amber-400 rounded-full animate-pulse"></div>
                      <span className="text-amber-300">🎉 Visual investigation experience gained!</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/60 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-6 mb-8 shadow-2xl">
                ...
                <div className="prose prose-invert max-w-none text-slate-300 leading-relaxed">
                  <p className="mb-3">You successfully uncovered the truth behind Rishi's fake disappearance through careful digital forensics:</p>
                  <ul className="list-disc list-inside space-y-2 mb-4">
                    <li>Exposed fake Reddit screenshots and fabricated evidence</li>
                    <li>Revealed the hoax plan to defame Sherpa companies for fame</li>
                    <li>Demonstrated the real-world consequences of online deception</li>
                    <li>Applied HTML/CSS investigation skills to solve the mystery</li>
                  </ul>
                  <p className="italic">🏆 You've now experienced both tutorial and visual investigation gameplay!</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button
                  onClick={() => {
                    setPuzzles(prev => prev.map(p => ({ ...p, solved: false, evidence: { ...p.evidence, revealed: false } })));
